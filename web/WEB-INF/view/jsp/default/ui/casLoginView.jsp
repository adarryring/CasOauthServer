...
<div class="box" id="login">
	...
	<a href="${CasOAuthWrapperClientUrl }">CasOAuthWrapperClientUrl</a>
  ...
  <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
    ...
    <section class="row">
      ...
      <c:choose>
        ...
        <c:otherwise>
          ...
          <form:input value="xh" cssClass="required" cssErrorClass="error" id="username" size="25" tabindex="1" accesskey="${userNameAccessKey}" path="username" autocomplete="off" htmlEscape="true" />
        </c:otherwise>
      </c:choose>
    </section>
    ...
    <section class="row">
      ...
      <form:password value="123" cssClass="required" cssErrorClass="error" id="password" size="25" tabindex="2" path="password"  accesskey="${passwordAccessKey}" htmlEscape="true" autocomplete="off" />
    </section>
